...
import { ArrowLeft, MapPin, Store, UtensilsCrossed, Loader2, Tag, CheckCircle2, XCircle } from 'lucide-react';
                ...
                <div className="card p-4 space-y-4">
                    ...
                    <div className="space-y-3">
                        ...
                        <label className="block">
                            ...
                            <input type="tel" value={phone} onChange={e => setPhone(e.target.value)} className="w-full bg-gray-50 border border-gray-200 rounded-lg px-3 py-2.5 text-gray-900 focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary" placeholder="+998 90 123 45 67" />
                        </label>

                        {orderType === 'delivery' && (
                            <label className="block">
                                <span className="text-sm text-gray-500 mb-1 block">Yetkazib berish manzili</span>
                                <textarea value={address} onChange={e => setAddress(e.target.value)} className="w-full bg-gray-50 border border-gray-200 rounded-lg px-3 py-2.5 text-gray-900 focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary h-20 resize-none" placeholder="Manzilni kiriting..." />
                            </label>
                        )}
